...
def seed_trades():
    ...
    demo_trade_16 = Trade(portfolio_id=3, ticker="H", execution_price=70, execution_type="BUY", quantity=45, transaction_date=date.today())
    demo_trade_17 = Trade(portfolio_id=3, ticker="MAR", execution_price=145, execution_type="SELL", quantity=25, transaction_date=date.today())
    demo_trade_18 = Trade(portfolio_id=3, ticker="IHG", execution_price=70, execution_type="SELL", quantity=35, transaction_date=date.today())
    demo_trade_19 = Trade(portfolio_id=4, ticker="CRC", execution_price=25, execution_type="BUY", quantity=10, transaction_date=date.today())
    demo_trade_20 = Trade(portfolio_id=4, ticker="HMPT", execution_price=6, execution_type="SELL", quantity=100, transaction_date=date.today())
    demo_trade_21 = Trade(portfolio_id=5, ticker="ALKS", execution_price=31, execution_type="SELL", quantity=250, transaction_date=date.today())
    demo_trade_22 = Trade(portfolio_id=5, ticker="AMBA", execution_price=150, execution_type="SELL", quantity=150, transaction_date=date.today())
    demo_trade_23 = Trade(portfolio_id=5, ticker="SEDG", execution_price=265, execution_type="BUY", quantity=50, transaction_date=date.today())
    demo_trade_24 = Trade(portfolio_id=5, ticker="FIVE", execution_price=236, execution_type="BUY", quantity=25, transaction_date=date.today())
    demo_trade_25 = Trade(portfolio_id=5, ticker="MOS", execution_price=37, execution_type="SELL", quantity=350, transaction_date=date.today())
