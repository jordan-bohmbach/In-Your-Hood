...
def seed_watchlists():
    ...
    demo_watchlist_6 = Watchlist(name='Travel', description='I love traveling', owner_id=1)
    demo_watchlist_7 = Watchlist(name='Small-Cap', description='Small-Cap Stocks', owner_id=1)
    demo_watchlist_8 = Watchlist(name='Mid-Cap', description='Mid-Cap Stocks', owner_id=1)
    demo_watchlist_9 = Watchlist(name='Large-Cap', description='Large-Cap Stocks', owner_id=1)
